...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (createAuthDto) {
            return __awaiter(this, void 0, void 0, function () {
                var hashedPassword, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, bcrypt.hash(createAuthDto.password, 10)];
                        case 1:
                        ...
                        case 2:
                            user = _a.sent();
                            return [2 /*return*/, { message: 'User berhasil didaftarkan', user: user }];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            if (!user)
                                throw new common_1.UnauthorizedException('Username salah');
                            return [4 /*yield*/, bcrypt.compare(loginDto.password, user.password)];
                        case 2:
                            isPasswordValid = _b.sent();
                            if (!isPasswordValid)
                                throw new common_1.UnauthorizedException('Password salah');
                            payload = { sub: user.user_id, username: user.username, role: user.id_role };
                            _a = {};
