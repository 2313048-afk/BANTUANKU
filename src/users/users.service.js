...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.prisma.users.create({
                                    data: {
                                        user_id: dto.user_id,
        ...
        UsersService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.users.findMany({
                            select: {
                                user_id: true,
                                username: true,
                                id_role: true,
        ...
        UsersService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.users.findUnique({
                            where: { user_id: id },
                        })];
                });
            });
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a.password = _b.sent();
                            _b.label = 2;
                        case 2: return [2 /*return*/, this.prisma.users.update({
                                where: { user_id: id },
                                data: dataToUpdate,
                            })];
                    }
        ...
        UsersService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.users.delete({
                            where: { user_id: id },
                        })];
                });
            });
